...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/solitary-mud-e2e5)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/solitary-mud-e2e5
```

A live public deployment of this template is available at [https://solitary-mud-e2e5.templates.workers.dev](https://solitary-mud-e2e5.templates.workers.dev)
